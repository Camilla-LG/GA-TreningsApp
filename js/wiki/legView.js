...
=======
   <!-- <img class="wikiShoulder" src="https://www.shoulder-pain-explained.com/images/shoulder-bones-anatomy.png"><img> -->
    <div class="treningsInfo">Legs <p>   
    <li>Dype step-ups: Bruk en stepkasse eller en lav benk. Trinn opp med en fot, så det andre benet følger etter. Gå helt opp og senk deg ned igjen. Gjenta på begge sider.</li>
...
=======
     ...
     <div class="nextArrow" id="nextArrow" onclick="selectExcercise(this)" videoUrl="https://www.youtube.com/embed/E1DE1dmEDio"></div>
>>>>>>> Stashed changes
